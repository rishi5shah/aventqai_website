...
export const INDUSTRY_PAGES = {
  accounting: {
    ...
    panel: {
      label: "aventeq://accounting",
      rows: [
        ["intelligent-reconciliation", "1,284 / 1,284 matched", "var(--green-light)"],
        ["tax-optimization-agent", "3 opportunities flagged", "var(--terra-light)"],
        ["notice-analysis-agent", "2 notices triaged", "rgba(244,241,233,0.6)"],
        ["compliance-workflows", "All filings on track", "var(--green-light)"],
      ],
      footerText: "monitoring close cycle",
    },
    painPoints: [
    ...
    useCases: [
      ...
      { title: "Financial Reporting Agent", desc: "Assembles management reports and variance analysis straight from the ledger, ready before the close meeting." },
    ],
    caseStudy: {
      tag: "Accounting & Tax",
  ...
  manufacturing: {
    ...
    panel: {
      label: "aventeq://manufacturing",
      rows: [
        ["production-intelligence", "Line 3 — on schedule", "var(--green-light)"],
        ["procurement-agent", "vendor delay · HIGH ▲", "var(--terra-light)"],
        ["vendor-coordination", "12 vendors synced", "rgba(244,241,233,0.6)"],
        ["predictive-alerts", "1 alert routed", "var(--terra-light)"],
      ],
      footerText: "watching the line",
    },
    painPoints: [
    ...
    useCases: [
      ...
      { title: "Inventory Intelligence", desc: "Tracks stock levels against demand signals so reorders happen before a shortage hits the line." },
    ],
    caseStudy: {
      tag: "Manufacturing",
  ...
  logistics: {
    ...
    panel: {
      label: "aventeq://logistics",
      rows: [
        ["shipment-intelligence", "ETA variance −5.2d", "var(--green-light)"],
        ["workflow-automation", "84 handoffs automated", "rgba(244,241,233,0.6)"],
        ["delay-prediction", "2 delays forecast", "var(--terra-light)"],
        ["escalation-systems", "0 open exceptions", "var(--green-light)"],
      ],
      footerText: "tracking active shipments",
    },
    painPoints: [
    ...
    useCases: [
      ...
      { title: "Carrier Performance Agent", desc: "Scores carrier reliability from real delivery data, so sourcing decisions are based on performance, not habit." },
    ],
    caseStudy: {
      tag: "Logistics",
  ...
  law: {
    ...
    panel: {
      label: "aventeq://law",
      rows: [
        ["legal-research-intelligence", "14 precedents surfaced", "rgba(244,241,233,0.6)"],
        ["contract-intelligence", "3 risk clauses flagged", "var(--terra-light)"],
        ["matter-management", "All deadlines on track", "var(--green-light)"],
        ["compliance-intelligence", "1 filing due in 3d", "var(--terra-light)"],
      ],
      footerText: "reviewing active matters",
    },
    painPoints: [
    ...
    useCases: [
      ...
      { title: "Discovery Intelligence", desc: "Surfaces relevant documents and flags privilege issues across large discovery sets automatically." },
    ],
    caseStudy: {
      tag: "Law Firm",
  ...
  "real-estate": {
    ...
    panel: {
      label: "aventeq://real-estate",
      rows: [
        ["lease-abstraction-agent", "6 leases processed", "rgba(244,241,233,0.6)"],
        ["listing-document-automation", "4 listings ready", "var(--green-light)"],
        ["tenant-communication", "9 inquiries handled", "rgba(244,241,233,0.6)"],
        ["market-intelligence", "Comps updated · 2m ago", "var(--green-light)"],
      ],
      footerText: "syncing active listings",
    },
    painPoints: [
    ...
    useCases: [
      ...
      { title: "Maintenance Coordination Agent", desc: "Routes maintenance requests to the right vendor and tracks resolution, so nothing falls through email." },
    ],
    caseStudy: {
      tag: "Real Estate",
